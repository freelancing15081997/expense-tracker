...
export const BOOKS_CATALOG: { domain: string; items: { name: string; href?: string; status: DomainStatus }[] }[] = [
  {
    ...
    items: [
      ...
      { name: 'Recurring invoices / bills', href: '/books/recurring', status: 'live' },
      { name: 'Accounting Periods', href: '/books/periods', status: 'live' },
      { name: 'Month-End Close', href: '/books/close', status: 'live' },
      { name: 'Trial Balance / P&L / Balance Sheet', href: '/books/reports', status: 'live' },
      { name: 'Cash flow (direct)', href: '/books/reports', status: 'live' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Estimates → Invoice', href: '/books/estimates', status: 'live' },
      { name: 'Quotes → Invoice', href: '/books/quotes', status: 'live' },
      { name: 'Sales Orders → Invoice', href: '/books/sales-orders', status: 'live' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Bank feeds / Open Banking', status: 'adapter' },
    ],
  },
  {
    domain: 'Operations',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'CFO dashboard', href: '/books/cfo', status: 'live' },
